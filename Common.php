...
require_once("ControllerDisplay.php");	// controls what to display to the users
require_once("ControllerFunction.php");	// controls all the functions
